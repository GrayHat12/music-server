...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AudioServer.SongResponse();
  });
  ...
  describe('SongResponse', function() {
    it('should create an instance of SongResponse', function() {
      // uncomment below and update the code to test SongResponse
      //var instance = new AudioServer.SongResponse();
      //expect(instance).to.be.a(AudioServer.SongResponse);
    });
